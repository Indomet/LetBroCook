<template>
    <div>
        <div class="d-flex flex-wrap">
            <div v-for="[key, recipe] in visibleRecipesMap" :key="recipe._id"
    ...
    <div class="wrapper">
  <a class="cta" @click="loadMoreRecipes">
...
export default {
    ...
    methods: {
        ...
        mapArray() {
            ...
            for (const each of this.recipeData) {
                each.tags = this.trimTagList(each.tags)
                map.set(each._id, each)
            }
            this.recipeMap = map
            this.visibleRecipesMap =
                Array.from(this.recipeMap).slice(0, this.visibleRecipesNumber)
            console.log(this.visibleRecipesMap)
        },
        loadMoreRecipes() {
            this.visibleRecipesNumber += 4
            this.visibleRecipesMap = Array.from(this.recipeMap).slice(0, this.visibleRecipesNumber)
        }
    }
