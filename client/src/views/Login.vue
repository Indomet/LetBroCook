              ...
              <div class="row justify-content-center">
                <div class="col-md-10 col-lg-6 col-xl- order-2 order-lg-1">
                  ...
                  <form @submit.prevent="handleSubmit" class="mx-1 mx-md-4">
                    <div
                      class="hs-firstname d-flex flex-row align-items-center mb-4"
                    >
                      ...
                      <div class="form-outline flex-fill mb-0">
                        ...
                        />
                        <div v-if="getError('email')" class="invalid-feedback">
                          {{ getError('email') }}
                        </div>
                      </div>
                    </div>
                ...
                <div
                  class="mouse col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2"
                >
                  <img
